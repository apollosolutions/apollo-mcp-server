...
export type BuildRouterVersionResult =
	| BuildRouterVersionSuccess
...
export type CreateProposalLifecycleSubscriptionResult =
	| PermissionError
...
export type CustomCheckConfigurationResult =
...
export type DeleteProposalLifecycleSubscriptionResult =
...
export type FeatureIntrosInput = {
	/** @deprecated No longer supported */
	devGraph?: InputMaybe<Scalars["Boolean"]["input"]>;
...
export type MutationNewServiceArgs = {
	...
	id: Scalars["ID"]["input"];
	isDev?: InputMaybe<Scalars["Boolean"]["input"]>;
	name?: InputMaybe<Scalars["String"]["input"]>;
...
export type ProposalsMustBeApprovedByADefaultReviewerResult =
	| PermissionError
	| Service
	| ValidationError;
...
export type QueueTestProposalLifecycleNotificationResult =
	| NotFoundError
	| PermissionError
...
export type ReRunCheckForRevisionResult =
	| NotFoundError
	| PermissionError
	| Proposal
	| ValidationError;
...
export type ReplaceReviewersWithDefaultReviewersResult =
	| PermissionError
	| Proposal
	| ValidationError;
...
export type RouterPreCreateDomainResult =
	| InternalServerError
	| InvalidInputErrors
	| RouterPreCreateDomainSuccess;
...
export type RouterSetLastTrafficResult =
	| InternalServerError
	| InvalidInputErrors
	| RouterSetLastTrafficSuccess;
...
export type RouterSetNextStatusResult =
	| InternalServerError
	| InvalidInputErrors
	| RouterSetNextStatusSuccess;
...
export type SetProposalsMustBeReApprovedOnChangeResult =
	| PermissionError
	| Service
	| ValidationError;
...
export type UpdateProposalLifecycleSubscriptionResult =
	| NotFoundError
	| PermissionError
	| ProposalLifecycleSubscription
	| ValidationError;
...
export type McpServerPqListQueryVariables = Exact<{
	graphId: Scalars["ID"]["input"];
	persistedQueryListId: Scalars["ID"]["input"];
	last?: InputMaybe<Scalars["Int"]["input"]>;
}>;

export type McpServerPqListQuery = {
	__typename?: "Query";
	graph?: {
		__typename?: "Service";
		persistedQueryList?: {
			...
			operations: {
				...
				edges: Array<{
					__typename?: "PersistedQueryEdge";
					node: { __typename?: "PersistedQuery"; body: any; id: string };
				}>;
			};
		} | null;
	} | null;
...
export const McpServerPqListDocument = {
	kind: "Document",
	definitions: [
		{
			kind: "OperationDefinition",
			operation: "query",
			name: { kind: "Name", value: "MCPServerPQList" },
			variableDefinitions: [
				{
				...
				},
				{
					...
					variable: {
						kind: "Variable",
						name: { kind: "Name", value: "persistedQueryListId" },
					},
					type: {
						kind: "NonNullType",
						type: { kind: "NamedType", name: { kind: "Name", value: "ID" } },
				...
				selections: [
					{
						...
						selectionSet: {
							...
							selections: [
								{
									kind: "Field",
									name: { kind: "Name", value: "persistedQueryList" },
									arguments: [
										{
											kind: "Argument",
											name: { kind: "Name", value: "id" },
...
} as unknown as DocumentNode<McpServerPqListQuery, McpServerPqListQueryVariables>;
